...
// Petit debounce local (remplace lodash, non necessaire pour ce seul usage)
      ...
      <ThemeProvider theme={theme}>
        ...
        <main className="container-fluid">
          <Routes>
            ...
            <Route path="/signup" element={<RegistrationForm onLogin={handleLogin} navigate={debouncedNavigate} />} />
            ...
            <Route path="/messages/:id" element={isLoggedIn ? (
              <React.Fragment>
                <MessagesContainer messageQuery="getOneMessage" />
